...
Follow the guidelines on the main github page: https://github.com/SUNCAT-Center/CatHub/blob/master/README.md , and see if you can prepare local db file for data upload.
